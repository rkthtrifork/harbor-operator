...
func main() {
	...
	// Metrics can be enabled and configured through the Helm chart.
	...
	if secureMetrics {
		// Require Kubernetes authentication and authorization for metrics.
	...
	//
	// The Helm chart can mount a certificate Secret and configure metricsCertPath.
