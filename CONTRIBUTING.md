...
Use `make check-drift` when only generated code, manifests, chart assets, and API reference drift need to be checked. The command preserves pre-existing feature-branch changes when deciding whether regeneration introduced additional drift.
